define(['jquery', 'TGraphics', 'TError', 'TParser', 'TEnvironment', 'TInterpreter', 'TUtils', 'TI18n', 'TResource'], function($, TGraphics, TError, TParser, TEnvironment, TInterpreter, TUtils, TI18n, TResource) {
    function TRuntime() {
        var runtimeFrame;
